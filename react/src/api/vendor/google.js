...
(function() {
  ...
  var R = decodeURI('%73cript'),
    ...
    U = function() {
      var a = A.nonce;
      return void 0 !== a
        ? a && a === String(a) && a.match(S)
          ? a
          : (A.nonce = null)
        : h.querySelector
          ? (a = h.querySelector('script[nonce]'))
...
gapi.load('', {
  ...
  _c: {
    jsl: {
      ...
      h:
        'm;/_/scs/apps-static/_/js/k\u003doz.gapi.en.4GHDg2SAUCE.O/am\u003dwQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCMFc55ucm77jZpLAHzHyu5ZyE7uKw/m\u003d__features__',
      u: 'https://apis.google.com/js/api.js',
      hee: true,
      fp: 'f812669680a72b7ee626278259aacd1114b865f4',
      dpo: false
    },
    fp: 'f812669680a72b7ee626278259aacd1114b865f4',
    annotation: [
